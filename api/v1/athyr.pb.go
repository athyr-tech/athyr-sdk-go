...
type ListAgentsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SkillFilter   string                 `protobuf:"bytes,1,opt,name=skill_filter,json=skillFilter,proto3" json:"skill_filter,omitempty"` // Optional: filter by skill ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListAgentsRequest) GetSkillFilter() string {
	if x != nil {
...
type AgentInfo struct {
	...
	Card          *AgentCard             `protobuf:"bytes,2,opt,name=card,proto3" json:"card,omitempty"`
...
func (x *AgentInfo) GetCard() *AgentCard {
	if x != nil {
		return x.Card
	}
	return nil
...
type DurableStreamInfo struct {
	...
	Subject       string                 `protobuf:"bytes,2,opt,name=subject,proto3" json:"subject,omitempty"`                      // Subject to subscribe to for direct access
	Stream        string                 `protobuf:"bytes,3,opt,name=stream,proto3" json:"stream,omitempty"`                        // Stream name for persistence
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KVDeleteRequest) Reset() {
	*x = KVDeleteRequest{}
	mi := &file_athyr_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KVDeleteRequest) Descriptor() ([]byte, []int) {
	return file_athyr_proto_rawDescGZIP(), []int{43}
}
...
func (x *KVDeleteResponse) Reset() {
	*x = KVDeleteResponse{}
	mi := &file_athyr_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KVDeleteResponse) Descriptor() ([]byte, []int) {
	return file_athyr_proto_rawDescGZIP(), []int{44}
}
...
func (x *KVListRequest) Reset() {
	*x = KVListRequest{}
	mi := &file_athyr_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KVListRequest) Descriptor() ([]byte, []int) {
	return file_athyr_proto_rawDescGZIP(), []int{45}
}
...
func (x *KVListResponse) Reset() {
	*x = KVListResponse{}
	mi := &file_athyr_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KVListResponse) Descriptor() ([]byte, []int) {
	return file_athyr_proto_rawDescGZIP(), []int{46}
}
...
const file_athyr_proto_rawDesc = "" +
	...
	"\fskill_filter\x18\x01 \x01(\tR\vskillFilter\"\xd4\x01\n" +
	"\tAgentInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12'\n" +
	"\x04card\x18\x02 \x01(\v2\x13.athyr.v1.AgentCardR\x04card\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12=\n" +
	"\fconnected_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vconnectedAt\x127\n" +
	"\tlast_seen\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\blastSeen\"A\n" +
	"\x12ListAgentsResponse\x12+\n" +
	"\x06agents\x18\x01 \x03(\v2\x13.athyr.v1.AgentInfoR\x06agents\",\n" +
	...
	"\x04keys\x18\x01 \x03(\tR\x04keys2\xab\x0e\n" +
	"\x05Athyr\x12V\n" +
	...
	"\aAddHint\x12\x18.athyr.v1.AddHintRequest\x1a\x19.athyr.v1.AddHintResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/sessions/{session_id}/hints\x12[\n" +
	"\n" +
	"ListAgents\x12\x1b.athyr.v1.ListAgentsRequest\x1a\x1c.athyr.v1.ListAgentsResponse\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/v1/agents\x12Y\n" +
	"\bGetAgent\x12\x19.athyr.v1.GetAgentRequest\x1a\x13.athyr.v1.AgentInfo\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/agents/{agent_id}\x12W\n" +
	...
	"\x06KVList\x12\x17.athyr.v1.KVListRequest\x1a\x18.athyr.v1.KVListResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/kv/{bucket}B9Z7github.com/athyr-tech/athyr-proto/gen/go/athyr/v1;athyrb\x06proto3"
...
var file_athyr_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_athyr_proto_goTypes = []any{
	...
	(*ListAgentsRequest)(nil),     // 7: athyr.v1.ListAgentsRequest
	(*AgentInfo)(nil),             // 8: athyr.v1.AgentInfo
	(*ListAgentsResponse)(nil),    // 9: athyr.v1.ListAgentsResponse
	(*GetAgentRequest)(nil),       // 10: athyr.v1.GetAgentRequest
	(*PublishRequest)(nil),        // 11: athyr.v1.PublishRequest
	(*PublishResponse)(nil),       // 12: athyr.v1.PublishResponse
	(*SubscribeRequest)(nil),      // 13: athyr.v1.SubscribeRequest
	(*SubscribeMessage)(nil),      // 14: athyr.v1.SubscribeMessage
	(*RequestMessage)(nil),        // 15: athyr.v1.RequestMessage
	(*ResponseMessage)(nil),       // 16: athyr.v1.ResponseMessage
	(*Message)(nil),               // 17: athyr.v1.Message
	(*Tool)(nil),                  // 18: athyr.v1.Tool
	(*ToolCall)(nil),              // 19: athyr.v1.ToolCall
	(*CompletionConfig)(nil),      // 20: athyr.v1.CompletionConfig
	(*CompletionRequest)(nil),     // 21: athyr.v1.CompletionRequest
	(*TokenUsage)(nil),            // 22: athyr.v1.TokenUsage
	(*CompletionResponse)(nil),    // 23: athyr.v1.CompletionResponse
	(*StreamChunk)(nil),           // 24: athyr.v1.StreamChunk
	(*DurableStreamInfo)(nil),     // 25: athyr.v1.DurableStreamInfo
	(*ResumeStreamRequest)(nil),   // 26: athyr.v1.ResumeStreamRequest
	(*ListModelsRequest)(nil),     // 27: athyr.v1.ListModelsRequest
	(*Model)(nil),                 // 28: athyr.v1.Model
	(*ListModelsResponse)(nil),    // 29: athyr.v1.ListModelsResponse
	(*SessionProfile)(nil),        // 30: athyr.v1.SessionProfile
	(*CreateSessionRequest)(nil),  // 31: athyr.v1.CreateSessionRequest
	(*GetSessionRequest)(nil),     // 32: athyr.v1.GetSessionRequest
	(*DeleteSessionRequest)(nil),  // 33: athyr.v1.DeleteSessionRequest
	(*DeleteSessionResponse)(nil), // 34: athyr.v1.DeleteSessionResponse
	(*SessionMessage)(nil),        // 35: athyr.v1.SessionMessage
	(*Session)(nil),               // 36: athyr.v1.Session
	(*AddHintRequest)(nil),        // 37: athyr.v1.AddHintRequest
	(*AddHintResponse)(nil),       // 38: athyr.v1.AddHintResponse
	(*KVGetRequest)(nil),          // 39: athyr.v1.KVGetRequest
	(*KVGetResponse)(nil),         // 40: athyr.v1.KVGetResponse
	(*KVPutRequest)(nil),          // 41: athyr.v1.KVPutRequest
	(*KVPutResponse)(nil),         // 42: athyr.v1.KVPutResponse
	(*KVDeleteRequest)(nil),       // 43: athyr.v1.KVDeleteRequest
	(*KVDeleteResponse)(nil),      // 44: athyr.v1.KVDeleteResponse
	(*KVListRequest)(nil),         // 45: athyr.v1.KVListRequest
	(*KVListResponse)(nil),        // 46: athyr.v1.KVListResponse
	nil,                           // 47: athyr.v1.AgentCard.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 48: google.protobuf.Timestamp
}
var file_athyr_proto_depIdxs = []int32{
	47, // 0: athyr.v1.AgentCard.metadata:type_name -> athyr.v1.AgentCard.MetadataEntry
	0,  // 1: athyr.v1.ConnectRequest.agent_card:type_name -> athyr.v1.AgentCard
	48, // 2: athyr.v1.ConnectResponse.connected_at:type_name -> google.protobuf.Timestamp
	48, // 3: athyr.v1.HeartbeatResponse.server_time:type_name -> google.protobuf.Timestamp
	0,  // 4: athyr.v1.AgentInfo.card:type_name -> athyr.v1.AgentCard
	48, // 5: athyr.v1.AgentInfo.connected_at:type_name -> google.protobuf.Timestamp
	48, // 6: athyr.v1.AgentInfo.last_seen:type_name -> google.protobuf.Timestamp
	8,  // 7: athyr.v1.ListAgentsResponse.agents:type_name -> athyr.v1.AgentInfo
	19, // 8: athyr.v1.Message.tool_calls:type_name -> athyr.v1.ToolCall
	17, // 9: athyr.v1.CompletionRequest.messages:type_name -> athyr.v1.Message
	20, // 10: athyr.v1.CompletionRequest.config:type_name -> athyr.v1.CompletionConfig
	18, // 11: athyr.v1.CompletionRequest.tools:type_name -> athyr.v1.Tool
	22, // 12: athyr.v1.CompletionResponse.usage:type_name -> athyr.v1.TokenUsage
	19, // 13: athyr.v1.CompletionResponse.tool_calls:type_name -> athyr.v1.ToolCall
	22, // 14: athyr.v1.StreamChunk.usage:type_name -> athyr.v1.TokenUsage
	25, // 15: athyr.v1.StreamChunk.stream_info:type_name -> athyr.v1.DurableStreamInfo
	19, // 16: athyr.v1.StreamChunk.tool_calls:type_name -> athyr.v1.ToolCall
	28, // 17: athyr.v1.ListModelsResponse.models:type_name -> athyr.v1.Model
	30, // 18: athyr.v1.CreateSessionRequest.profile:type_name -> athyr.v1.SessionProfile
	48, // 19: athyr.v1.SessionMessage.timestamp:type_name -> google.protobuf.Timestamp
	35, // 20: athyr.v1.Session.messages:type_name -> athyr.v1.SessionMessage
	30, // 21: athyr.v1.Session.profile:type_name -> athyr.v1.SessionProfile
	48, // 22: athyr.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	48, // 23: athyr.v1.Session.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 24: athyr.v1.Athyr.Connect:input_type -> athyr.v1.ConnectRequest
	3,  // 25: athyr.v1.Athyr.Heartbeat:input_type -> athyr.v1.HeartbeatRequest
	5,  // 26: athyr.v1.Athyr.Disconnect:input_type -> athyr.v1.DisconnectRequest
	11, // 27: athyr.v1.Athyr.Publish:input_type -> athyr.v1.PublishRequest
	13, // 28: athyr.v1.Athyr.Subscribe:input_type -> athyr.v1.SubscribeRequest
	15, // 29: athyr.v1.Athyr.Request:input_type -> athyr.v1.RequestMessage
	21, // 30: athyr.v1.Athyr.Complete:input_type -> athyr.v1.CompletionRequest
	21, // 31: athyr.v1.Athyr.CompleteStream:input_type -> athyr.v1.CompletionRequest
	26, // 32: athyr.v1.Athyr.ResumeStream:input_type -> athyr.v1.ResumeStreamRequest
	27, // 33: athyr.v1.Athyr.ListModels:input_type -> athyr.v1.ListModelsRequest
	31, // 34: athyr.v1.Athyr.CreateSession:input_type -> athyr.v1.CreateSessionRequest
	32, // 35: athyr.v1.Athyr.GetSession:input_type -> athyr.v1.GetSessionRequest
	33, // 36: athyr.v1.Athyr.DeleteSession:input_type -> athyr.v1.DeleteSessionRequest
	37, // 37: athyr.v1.Athyr.AddHint:input_type -> athyr.v1.AddHintRequest
	7,  // 38: athyr.v1.Athyr.ListAgents:input_type -> athyr.v1.ListAgentsRequest
	10, // 39: athyr.v1.Athyr.GetAgent:input_type -> athyr.v1.GetAgentRequest
	39, // 40: athyr.v1.Athyr.KVGet:input_type -> athyr.v1.KVGetRequest
	41, // 41: athyr.v1.Athyr.KVPut:input_type -> athyr.v1.KVPutRequest
	43, // 42: athyr.v1.Athyr.KVDelete:input_type -> athyr.v1.KVDeleteRequest
	45, // 43: athyr.v1.Athyr.KVList:input_type -> athyr.v1.KVListRequest
	2,  // 44: athyr.v1.Athyr.Connect:output_type -> athyr.v1.ConnectResponse
	4,  // 45: athyr.v1.Athyr.Heartbeat:output_type -> athyr.v1.HeartbeatResponse
	6,  // 46: athyr.v1.Athyr.Disconnect:output_type -> athyr.v1.DisconnectResponse
	12, // 47: athyr.v1.Athyr.Publish:output_type -> athyr.v1.PublishResponse
	14, // 48: athyr.v1.Athyr.Subscribe:output_type -> athyr.v1.SubscribeMessage
	16, // 49: athyr.v1.Athyr.Request:output_type -> athyr.v1.ResponseMessage
	23, // 50: athyr.v1.Athyr.Complete:output_type -> athyr.v1.CompletionResponse
	24, // 51: athyr.v1.Athyr.CompleteStream:output_type -> athyr.v1.StreamChunk
	24, // 52: athyr.v1.Athyr.ResumeStream:output_type -> athyr.v1.StreamChunk
	29, // 53: athyr.v1.Athyr.ListModels:output_type -> athyr.v1.ListModelsResponse
	36, // 54: athyr.v1.Athyr.CreateSession:output_type -> athyr.v1.Session
	36, // 55: athyr.v1.Athyr.GetSession:output_type -> athyr.v1.Session
	34, // 56: athyr.v1.Athyr.DeleteSession:output_type -> athyr.v1.DeleteSessionResponse
	38, // 57: athyr.v1.Athyr.AddHint:output_type -> athyr.v1.AddHintResponse
	9,  // 58: athyr.v1.Athyr.ListAgents:output_type -> athyr.v1.ListAgentsResponse
	8,  // 59: athyr.v1.Athyr.GetAgent:output_type -> athyr.v1.AgentInfo
	40, // 60: athyr.v1.Athyr.KVGet:output_type -> athyr.v1.KVGetResponse
	42, // 61: athyr.v1.Athyr.KVPut:output_type -> athyr.v1.KVPutResponse
	44, // 62: athyr.v1.Athyr.KVDelete:output_type -> athyr.v1.KVDeleteResponse
	46, // 63: athyr.v1.Athyr.KVList:output_type -> athyr.v1.KVListResponse
